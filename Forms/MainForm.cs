...
namespace Optimizer
{
    public sealed partial class MainForm : Form
    {
        ...
        readonly string _feedLink = "";
        readonly string _feedImages = "";

        readonly string _licenseLink = "";
        readonly string _discordLink = "";
        readonly string _githubProjectLink = "";
        readonly string _paypalSupportLink = "";

        readonly string _latestVersionLink = "";
        //readonly string _changelogLink = "";
        readonly string _changelogRawLink = "";
        ...
        {
            return string.Format("https://github.com/HBF7678/SystemEnhancer/releases/download/{0}/SystemEnhancer-{0}.exe", latestVersion);
        }
        ...
        private void EnableToggleEvents()
        {
            ...
            darkModeSw.ToggleClicked += darkModeSw_ToggleClicked;
        }
        ...
        public MainForm(SplashForm _splashForm, bool disableIndicium = false, bool disableHostsEditor = false, bool disableCommonApps = false, bool disableUWPApps = false, bool disableStartups = false, bool disableCleaner = false, bool disableIntegrator = false, bool disablePinger = false)
        {
            ...
            Options.IsDarkMode = Options.CurrentOptions.DarkMode;
            Options.UpdateThemeMode(Options.IsDarkMode);

            // theming
            Options.ApplyTheme(this);
            pictureBox1.BackColor = Options.ThemeColor;
            colorPicker1.Color = Options.ThemeColor;
        ...
        private void LoadTranslationAndSetSize()
        {
            ...
            else if (Options.CurrentOptions.LanguageCode == LanguageCode.JP)
            {
                boxLang.Text = "日本語";
                Translate();
            }
        ...
        private void boxLang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (boxLang.Text == "日本語")
            {
                ...
                Options.CurrentOptions.LanguageCode = LanguageCode.JP;
            }
        ...
        private void colorPicker1_ColorChanged(object sender, EventArgs e)
        {
            ...
            Options.ThemeColor = colorPicker1.Color;
            Options.ThemeColorAccent = ColorHelper.ChangeColorBrightness(colorPicker1.Color, 0.7);
        ...
        private void darkModeSw_ToggleClicked(object sender, EventArgs e)
        {
            Options.CurrentOptions.DarkMode = darkModeSw.ToggleChecked;
            Options.UpdateThemeMode(darkModeSw.ToggleChecked);
            Options.ApplyTheme(this);
            Options.SaveSettings();
        }
        ...
        private void DashboardButton_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorLogger.LogError("MainForm.DashboardButton_Click", ex.Message, ex.StackTrace);
