...
{
    public static class WindowsSystemEnhancer
    {
        readonly static string DiagnosticsDataPath = Path.Combine(CleanHelper.ProgramData, @"Microsoft\Diagnosis\ETLLogs\AutoLogger");

        internal static void DisableDataCollection()
        {
            Utilities.PreventProcessFromRunning("CompatTelRunner.exe");
            Utilities.PreventProcessFromRunning("DeviceCensus.exe");
        }

        internal static void ApplySystemOptimizations(System.Object Registry)
        {
        ...
        internal static void DisableSystemOptimizations()
        {
            try
            {
            ...
            {
                ErrorLogger.LogError("WindowsSystemEnhancer.DisableSystemOptimizations", ex.Message, ex.StackTrace);
            }
        }

        internal static void DisableDataCollectionServices()
        {
            Utilities.StopService("DiagTrack");
            Utilities.StopService("diagnosticshub.standardcollector.service");
            Utilities.StopService("dmwappushservice");
        ...
        internal static void EnableDataCollectionServices()
        {
            Registry.SetValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\DiagTrack", "Start", "2", RegistryValueKind.DWord);
            Registry.SetValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\diagnosticshub.standardcollector.service", "Start", "2", RegistryValueKind.DWord);
            Registry.SetValue(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\dmwappushservice", "Start", "2", RegistryValueKind.DWord);
        ...
        internal static void EnableNetworkThrottling()
        {
            ...
            {
                ErrorLogger.LogError("WindowsSystemEnhancer.EnableNetworkThrottling", ex.Message, ex.StackTrace);
            }
        }
        ...
        //    catch (Exception ex)
        //    {
        //        ErrorLogger.LogError("WindowsSystemEnhancer.EnableSkypeAds", ex.Message, ex.StackTrace);
        //    }
        //}
        ...
        internal static void DisableSystemRestore()
        {
            ...
            {
                ErrorLogger.LogError("WindowsSystemEnhancer.DisableSystemRestore", ex.Message, ex.StackTrace);
            }
        ...
        internal static void UninstallOneDrive()
        {
            ...
            foreach (string x in oneDriveFolders)
            {
                if (Directory.Exists(x))
                {
                    ...
                    {
                        ErrorLogger.LogError("WindowsSystemEnhancer.UninstallOneDrive", ex.Message, ex.StackTrace);
                    }
                }
            }
        ...
        internal static void InstallOneDrive()
        {
            ...
            {
                ErrorLogger.LogError("WindowsSystemEnhancer.InstallOneDrive", ex.Message, ex.StackTrace);
            }
        }
        ...
        internal static void EnableXboxLive()
        {
            ...
            {
                ErrorLogger.LogError("WindowsSystemEnhancer.EnableXboxLive", ex.Message, ex.StackTrace);
            }
        ...
        internal static void DisableTelemetryTasks()
        {
            ...
            Utilities.RunCommand(string.Format("icacls {0} /deny SYSTEM:`(OI`)`(CI`)F", DiagnosticsDataPath));
        ...
        internal static void EnableTelemetryTasks()
        {
            ...
            {
                ErrorLogger.LogError("WindowsSystemEnhancer.EnableTelemetryTasks", ex.Message, ex.StackTrace);
            }
        ...
        internal static void DisableOffice2016Telemetry()
        {
            ...
            {
                ErrorLogger.LogError("WindowsSystemEnhancer.DisableOffice2016Telemetry", ex.Message, ex.StackTrace);
            }
        ...
        internal static void EnableOffice2016Telemetry()
        {
            ...
            {
                ErrorLogger.LogError("WindowsSystemEnhancer.EnableOffice2016Telemetry", ex.Message, ex.StackTrace);
            }
        ...
        //    catch (Exception ex)
        //    {
        //        ErrorLogger.LogError("WindowsSystemEnhancer.DisableForcedFeatureUpdates", ex.Message, ex.StackTrace);
        //    }
        //}
        ...
        //    catch (Exception ex)
        //    {
        //        ErrorLogger.LogError("WindowsSystemEnhancer.EnableForcedFeatureUpdates", ex.Message, ex.StackTrace);
        //    }
        //}
        ...
        internal static void RemoveCastToDevice()
        {
            ...
            {
                ErrorLogger.LogError("WindowsSystemEnhancer.RemoveCastToDevice", ex.Message, ex.StackTrace);
            }
        }
        ...
        internal static void AddCastToDevice()
        {
            ...
            {
                ErrorLogger.LogError("WindowsSystemEnhancer.AddCastToDevice", ex.Message, ex.StackTrace);
            }
        }
        ...
        internal static void DisableVisualStudioTelemetry()
        {
            ...
            {
                ErrorLogger.LogError("WindowsSystemEnhancer.DisableVisualStudioTelemetry", ex.Message, ex.StackTrace);
            }
        }
        ...
        internal static void EnableVisualStudioTelemetry()
        {
            ...
            {
                ErrorLogger.LogError("WindowsSystemEnhancer.EnableVisualStudioTelemetry", ex.Message, ex.StackTrace);
            }
        }
